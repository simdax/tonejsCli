...
export default {
  ...
  getters: {
    ...
    synth (state, getters, rootState) {
      var synth = rootState.timbres[state.indexTimbre]
      return synth === undefined ? new Tone.Synth().toMaster() : synth.toneSynth
    },
    isPlaying (s) {
